...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Hola Paola Galbis ♥\nHonestamente quiero recordarte que TE AMO y que siempre estaré para TI cuando sientas que no puedes más.\nPorque aunque tengamos nuestras diferencias y en ocasiones mi paciencia sea poca, igualmente tendre motivos para estar junto a TI.\nYa que contigo tiene sentido vivir ¡Un Dia A La Vez!.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Porque mereces detalles bonitos,\nJessiel Mata";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2021-07-02T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2053-07-02T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Te amaré por <b>${eventDays}d </b> días más<br>`;
